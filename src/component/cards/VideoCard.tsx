    ...
    <div className="bg-white relative group">
      <Link to="/watch">
        <div className="relative">
          <img
            src="https://res.cloudinary.com/ddlfpv4gl/image/upload/v1724258429/images/rgnshssq3tb4umregfj8.png"
            alt=""
            className=" h-60 lg:h-52 w-full rounded-lg group-hover:hidden block"
          />
          <img
            src="https://64.media.tumblr.com/0f7f92a7b776d46633c1e439ef6a877c/tumblr_inline_o0lu2nvsg41to8h2v_500.gif"
            alt=""
            className=" h-60 lg:h-52 w-full rounded-lg hidden group-hover:block group-hover:rounded-none duration-100"
          />
