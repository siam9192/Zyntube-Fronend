        ...
        <div className="flex gap-2 md:gap-5 ">
          <div className=" group w-[40%]    relative  h-fit">
            <img
              ...
              alt=""
              className="rounded-lg object-cover w-full   md:h-[200px] lg:h-[220px] xl:h-[280px]  group-hover:hidden"
            />
            <img
              src={`https://image.mux.com/${media.muxPlaybackId}/animated.gif`}
              alt=""
              className="rounded-lg object-cover  w-full md:h-[200px] lg:h-[220px] xl:h-[280px] group-hover:block hidden"
            />
          ...
          <div className=" w-[60%] md:pr-5 pr-3 ">
            ...
            <div>
              <div className="flex items-center gap-1 md:gap-2 mt-2 md:mt-5">
                <img
                  className=" size-4 md:size-8 rounded-full"
