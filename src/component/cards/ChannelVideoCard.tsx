  ...
  return (
    <div className='bg-white relative group w-full'>
     ...
     <div className='relative'>
       <img src="https://images.pexels.com/photos/414612/pexels-photo-414612.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="" className='md:h-60 h-72 w-full rounded-lg group-hover:hidden block' />
       <img src="https://64.media.tumblr.com/0f7f92a7b776d46633c1e439ef6a877c/tumblr_inline_o0lu2nvsg41to8h2v_500.gif" alt="" className='h-60 w-full rounded-lg hidden group-hover:block group-hover:rounded-none duration-100' />
