...
function PlayListCard() {
  return (
    <div  className='relative playlist__card h-fit'>
      ...
      <img src="https://i.ytimg.com/vi/GSq133Zke2E/hqdefault.jpg?sqp=-oaymwEnCPYBEIoBSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLB31sxDJEpUheQ-uWdO0DuOluKsog" alt=""  className='w-full rounded-lg'/>
