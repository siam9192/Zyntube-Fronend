 ...
 useEffect(()=>{
  ...
  return (
   <div ref={ref} className='relative'>
    <img onClick={(p)=>setIsOpen(!isOpen)} src="https://yt3.googleusercontent.com/aduvRrAka4iwQ3XD7XR3agLNl5Uwqs4sNCf50CCPJkbOTjiE18ZgFKPeom5ZDBincl57v29tMz4=s160-c-k-c0x00ffffff-no-rj" alt=""  className='size-10 rounded-full  outline-2 outline-offset-1 outline-primary'/>
    <div className={`absolute   bg-white rounded-lg drop-shadow-2xl top-18 right-0  z-40 p-4 ${isOpen?'min-h-60 md:w-[400px] w-[250px]  ':'w-0 h-0 hidden'} duration-200 transition-all ease-in-out`}>
