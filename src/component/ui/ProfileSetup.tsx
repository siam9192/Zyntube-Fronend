              ...
              <div className="mt-5 space-y-4 animate__arrive__right__left">
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-800">
                    ...
                    you're creating. Changes to your name and photo will only be visible on YouTube,
                    not on any other Google services. You can change your name twice within 14 days.
                  </p>
                </div>
                <div className="space-y-2">
                  <label htmlFor="" className="font-medium text-lg block">
            ...
            <div>
              <div className="mt-5  animate__arrive__right__left">
                <div className="relative size-fit mx-auto">
                  <img
                    src={croppedAvatarImage || 'https://avatar.iran.liara.run/public/46'}
                    alt=""
