...
{
  categories.slice(0,12).map((category,index)=><button onClick={()=>setActiveIndex(index)} className={` tab__btn px-6 py-2 ${index === activeIndex ? 'active ':'bg-gray-100'} rounded-md`}>
    {category}
  </button>)
}
    </div>
