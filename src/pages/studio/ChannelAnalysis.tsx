    ...
    <div>
      ...
      <div className=" mt-10 grid grid-cols-4  gap-4  ">
        <div className="p-3 border-2 border-gray-600/10 rounded-md  min-h-32 flex justify-center items-center flex-col ">
          <h1 className="text-center text-4xl font-medium text-secondary">
            {(234545).toLocaleString()}
          </h1>
          <p className="mt-2 text-center text-gray-800 font-medium  text-sm">Videos</p>
        </div>
        <div className="p-3 border-2 border-gray-600/10 rounded-md  min-h-32 flex justify-center items-center flex-col ">
          <h1 className="text-center text-4xl font-medium text-secondary">
            {(234545).toLocaleString()}
          </h1>
          <p className="mt-2 text-center text-gray-800 font-medium  text-sm">Subscribers</p>
        </div>
        <div className="p-3 border-2 border-gray-600/10 rounded-md  min-h-32 flex justify-center items-center flex-col ">
          <h1 className="text-center text-4xl font-medium text-secondary">
            {(234545).toLocaleString()}
          </h1>
          <p className="mt-2 text-center text-gray-800 font-medium  text-sm">Watch time</p>
        </div>
        <div className="p-3 border-2 border-gray-600/10 rounded-md  min-h-32 flex justify-center items-center flex-col ">
          <h1 className="text-center text-4xl font-medium text-secondary">
            {(234545).toLocaleString()}
          </h1>
          <p className="mt-2 text-center text-gray-800 font-medium  text-sm">Revenue</p>
        </div>
      </div>
      ...
      <div className="mt-10 grid grid-cols-1 lg:grid-cols-6  gap-5 ">
        <div className="p-5 lg:col-span-4 border-2  border-pink-100 rounded-md">
          <h2 className="text-2xl text-black font-primary font-medium mb-5">Last 30 days views</h2>
          <SynchronizedAreaChart />
        </div>
        <div className="col-span-2 border-2  border-pink-100 rounded-md p-5">
          <h2 className="text-2xl text-black font-primary font-medium mb-5">Popular contents</h2>
          <div className="mt-5">
