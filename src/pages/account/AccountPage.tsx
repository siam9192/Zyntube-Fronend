...
export const AccountPage = () => {
  ...
  return (
    <Container>
       ...
       <div className="md:mt-10 mt-8">
        <div className="flex md:flex-row flex-col  md:gap-7 gap-4" >
            <img src="https://yt3.googleusercontent.com/aduvRrAka4iwQ3XD7XR3agLNl5Uwqs4sNCf50CCPJkbOTjiE18ZgFKPeom5ZDBincl57v29tMz4=s160-c-k-c0x00ffffff-no-rj" alt=""  className="md:size-40 size-32 rounded-full"/>
            <div>
                ...
                <div className="md:mt-3 mt-2 flex items-center  gap-2">
                    <button className="px-8  py-2 font-medium  border-2  border-gray-700/20 rounded-full   hover:bg-primary hover:border-none">Visit My Channel</button>
                    <button className="px-8  py-2 font-medium  border-2  border-gray-700/20 rounded-full   hover:bg-primary hover:border-none md:inline hidden">Go Home</button>
                    <button className="px-6  py-2 font-medium  border-2 bg-red-500  text-white rounded-full ">Logout</button>
                </div>
            </div>
        </div>
        <div className="mt-10">
    ...
    <div className="mt-5 grid lg:grid-cols-3 grid-cols-2  md:gap-8 gap-5">
     {
        routes.map(route=>(
            <div key={route.title} className="flex flex-col justify-center items-center p-5 border-2 border-gray-800/20 rounded-lg relative hover:bg-gray-100  hover:border-secondary">
    ...
    <div className="mt-10">
        <h2 className="text-2xl font-semibold font-primary">Help <span className="text-primary">&</span> Supports</h2>
        <div className="mt-5 grid lg:grid-cols-3 grid-cols-2  md:gap-8 gap-5">
     {
        routes.map(route=>(
            <div key={route.title} className="flex flex-col justify-center items-center p-5 border-2 border-gray-800/20 rounded-lg relative hover:bg-gray-100  hover:border-secondary">
